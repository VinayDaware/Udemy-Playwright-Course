...
test('Login with valid credentials,adding item to cart and validating item in cart and checkout', async function ({ page }) {
    ...
    await page.locator('tbody').waitFor();  // it will wait until full table body is loaded
    ...
    // here we did not put any external wait as the textContent() has auto wait capabilities
